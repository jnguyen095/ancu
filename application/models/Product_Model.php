...
class Product_Model extends CI_Model
{
	 ...
	 * @param $phoneNumber
	 * @return bool
	 * Chỉ có tài khoản user mới limit, còn lại đều valid
	 */
	public function isValidPost($loginId, $ipAddress, $phoneNumber){
		...
		$loginUser = $this->db->get("us3r")->row();
		if($loginUser->UserGroupID != USER_GROUP_CUSTOMER){
			$totalPost = (int)$loginUser->StandardPost;
