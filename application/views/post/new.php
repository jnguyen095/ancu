...
<div class="container-fluid">
	...
	<div class="row no-margin">
		<div class="col-lg-12 col-sm-12 no-padding">
				...
				<div class="block-panel">
					...
					<div class="block-body">
						<div class="form-group">
							...
							<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
								<label>Chi phí đăng tin <?=($this->session->userdata('loginid') != null) ? "(Số dư: <span class='label-available-mn'>" . number_format($user->AvailableMoney)." đ</span>)" : "0 đ" ; ?> </label>
								<div class="postCost">
			...
			<div class="col-lg-3 col-sm-3 no-padding-mobile">
				<?php
				if($currentGroup == 'BROKER' || $currentGroup == 'STAFF' || $currentGroup == 'ADMIN'){ ?>
					<div class="well">
						<div class="bg-primary text-white">
							<p class="text-center">Tài khoản không giới hạn tin đăng!</p>
						</div>
					</div>
				<?php } ?>
				...
				<div class="subscribe-panel col-md-12 no-padding">
					<div class="well">
						...
						<div class="guidline">
							<ul>
								<li><span class="pullet"><span class="label label-success">Siêu VIP</span>: Hiễn thị trang chủ, có gắn ngôi sao, đứng đầu các trang tìm kiếm và các gợi ý</span></li>
								...
								<li><span class="pullet">Tin Thường</span>: Bạn có tối đa <?=MAX_FREE_POST?> tin miễn phí, mỗi ngày đăng <?=MAX_POST_PER_DAY?> tin</span></li>
								<li class="text-right"><a href="<?=base_url('/bao-gia-dich-vu.html')?>"><p>>> Xem thêm thông tin thanh toán</p></a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<?php /* <script async defer src="https://maps.googleapis.com/maps/api/js?key=<?=GOOGLE_MAP_KEY?>&callback=defaultMap"></script> */ ?>
