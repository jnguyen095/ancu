...
<div class="footer row no-margin">
	...
	<div class="copyright text-center">
		<div>Copyright © 2024 nhadatancu.com ® Ghi rõ nguồn "nhadatancu.com" khi phát hành lại thông tin từ website này.</div>
		<div>Email:  contact@nhadatancu.com</div>
		<!-- <div><a rel="nofollow" href="skype:nhukhang095?chat" title="Chát với http://nhadatancu.com"><img src="<?=base_url('/img/skype.png')?>" alt="Skype icon"/></a> </div> -->
	</div>
...
<script type="application/ld+json">
{
    ...
    "@type": "WebSite",
    "url": "https://nhadatancu.com",
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://nhadatancu.com/tim-kiem.html?query={search_term_string}",
      "query-input": "required name=search_term_string"
    },
    "name": "nhadatancu.com",
    "alternateName": "Nhadatancu - Bất Động Sản - Mua Bán Chung Cư, Nhà Đất"
}
</script>
