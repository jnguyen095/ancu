...
<ul itemscope itemtype="http://schema.org/BreadcrumbList" class="breadcrumb">
	...
	<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="active"><span itemprop="item"><span itemprop="name">Không Gian Sống</span></span><meta itemprop="position" content="2" /></li>
	<?php $this->load->view('/common/quick-search')?>
</ul>
<div class="row no-margin">
	<div class="col-md-9  no-margin no-padding">
		<div class="search-result-panel col-md-12">Không Gian Sống</div>
							...
							<div class="row product-content">
								<div class="col-lg-7 col-sm-8 col-xs-9">
									<a href="<?=base_url() . seo_url($sampleHouse->Title) . '-s' . $sampleHouse->SampleHouseID?>.html">
										<img class="img-sample-house" src="<?=middleImageReplace($sampleHouse->Thumb)?>" alt="<?=$sampleHouse->Title?>"/>
									</a>
								</div>
