...
<head>
	...
	<title>Nhà Đất An Cư | Quản lý hợp tác</title>
					...
					<table class="admin-table table table-bordered table-striped">
						...
						foreach ($products as $product) {
							...
							<tr>
								...
								<td><?=$product->Commission?><?=($product->CommissionUnit == 'PERCENT' ? '%' : format_number($product->CommissionUnit).' VNĐ')?></td>
								<td></td>
								<td><?=$product->IpAddress?></td>
								<td>
									<a data-toggle="tooltip" title="Cập nhật"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;|&nbsp;
