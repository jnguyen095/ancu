...
// nha mau dep
$route['khong-gian-song'] = "SampleHouse_controller";
$route['khong-gian-song.html/(:num)'] = "SampleHouse_controller/index/$1";
...
// Bản đồ quy hoạch
$route['ban-do-quy-hoach'] = "Map_controller";
...
$route['admin/staff/list'] = "admin/UserManagement_controller/staffList";
