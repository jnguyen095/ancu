...
defined('USER_GROUP_BROKER')	OR define('USER_GROUP_BROKER', 4); // Môi giới

// Social IDs
defined('GOOGLE_MAP_KEY')		OR define('GOOGLE_MAP_KEY', 'AIzaSyCTRujHZaewV1ggtE6QIWY4xhgPnrODoZM'); // google map key https://nhadatancu.com
...
// defined('GOOGLE_ANALYTIC_ID')	OR define('GOOGLE_ANALYTIC_ID', 'G-XSFLVBPT63'); // Google Analytic production: https://nhadatancu.com
...
defined("MAX_FREE_POST")		OR define('MAX_FREE_POST', 5);
